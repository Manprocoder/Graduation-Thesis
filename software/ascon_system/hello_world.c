...
int init_mem0(int outgap, int des_addr) {
	...
	//CIPHERTEXT: da35f6df_f4db70da_bdd03d68_c6eb2300
	//TAG: 128'hcb94d323_cb084d23_fd8fb662_d02e0fb1
	/*int frame5[] = {0x140f0f0A, 0xEEEE1111, 0x9D79B1A3, 0x66223344, 0x88882345,
					0, 0, 0, 12, 0x12345643, 0xAAAACFCF, 0x4A5A5AE1, 0x62343300,
					0xda35f6df, 0xf4db70da, 0xbdd03d68, 0xc6eb2300,
	...
	********************************************************/
	// Frame list pointer
	    ...
	    int frame_length[] = {
			...
			sizeof(hash_384) / sizeof(int),
			sizeof(frame3) / sizeof(int),
			sizeof(frame4) / sizeof(int)
